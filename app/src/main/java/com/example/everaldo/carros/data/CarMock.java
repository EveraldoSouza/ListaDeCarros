package com.example.everaldo.carros.data;
...
public class CarMock {
    ...
    public List<Car> getCarMockList(Activity activity){
        ...
        Car bugattiChiron = new Car(++id, "Bugatti Chiron", "Bugatti", 1520,
                Double.valueOf( 1000000.00), ContextCompat.getDrawable(activity, R.mipmap.bugattichiron));
        mMockList.add(bugattiChiron);


        Car civicTypeR = new Car(++id, "Civic Type R", "Honda", 310,
                Double.valueOf(136000.00), ContextCompat.getDrawable(activity, R.mipmap.civictyper));
